...
class Fighter: Spaceship {
    var weapon = ""
    var remainingFirePoqwe = 5
    func fire(){
        if remainingFirePoqwe > 0 {
            remainingFirePoqwe -= 1
        }
        else {
...
destroyer.remainingFirePoqwe = 10
...
print("You can't because \"falcon\" is an instance of Spaceship class")
...
for _ in 0...10{
    destroyer.fire()
    print(destroyer.remainingFirePoqwe)
}
/*:
