...
class Fighter :Spaceship{
    var weapon = ""
    var remainingFirePowe = 5
    
    init(name:String,health:Int,position:Int,weapon:String,remainingFirePowe:Int){
        self.weapon = weapon
        self.remainingFirePowe = remainingFirePowe
...
var destroyer = Fighter(name: "Destroyer", health: 1, position: 1, weapon: "Laser", remainingFirePowe: 10)
destroyer.moveRight()
print(destroyer.moveRight())
