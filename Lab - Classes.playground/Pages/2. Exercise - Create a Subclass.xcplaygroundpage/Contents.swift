...
class Fighter : Spaceship {
    ...
    var remainingFirePowerm = 5
    func fire(){
        if remainingFirePowerm > 0{
            remainingFirePowerm -= 1
        }else{
...
destroyer.remainingFirePowerm = 10
...
print("اوبجكت من كلاس (Spaceship) ،، (destroyer) لذلك مازاح اقدر استدعيه للاوبجكت ")
...
destroyer.fire()
print(destroyer.remainingFirePowerm)
